...
export const APP_NAME = 'FilmBox'

/** URL scheme matching expo.scheme in app.json — used for OAuth deep link callbacks. */
export const APP_SCHEME = 'filmbox'

/** Support email shown on the Support screen. */
export const APP_SUPPORT_EMAIL = 'support@filmbox.app'

/** Documentation URL shown on the Support screen. */
export const APP_DOCS_URL = 'https://filmbox.app/docs'

/** One-liner shown on the landing page below the app name. */
export const APP_TAGLINE = 'Every moment. One roll.'

/** Short description used in marketing / onboarding contexts. */
export const APP_DESCRIPTION =
  'Capture moments together. Photos develop like real film — revealed to everyone after the wait.'
